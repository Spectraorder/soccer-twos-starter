...
CHECKPOINT_PATHS = {
    "phase1": os.path.abspath(os.path.join(
        os.path.dirname(__file__), "..", "checkpoints",
        "PPO_SoccerShapedMA_2541d_00000_0_2026-02-21_13-57-19",
        "checkpoint_001550", "checkpoint-1550"
    )),
...
if __name__ == "__main__":
    num_episodes = 30
    our_agent_phase = "phase1"
    opponent_agent_phase = "phase2"
