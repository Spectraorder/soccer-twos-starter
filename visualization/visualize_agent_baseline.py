...
def main():
    ...
    checkpoint_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "checkpoints", "PPO_SoccerShapedMABaseline_cfd23_00000_0_2026-02-23_16-51-31", "checkpoint_001650", "checkpoint-1650"))
